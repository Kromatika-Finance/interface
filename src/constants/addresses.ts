...
export const INCH_ROUTER_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.ARBITRUM_RINKEBY]: '0xa501c031958F579dB7676fF1CE78AD305794d579',
  [SupportedChainId.POLYGON]: '0x11111112542D85B3EF69AE05771c2dCCff4fAa26',
}
...
export const LIMIT_ORDER_MANAGER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.POLYGON_MUMBAI]: '0x5afAD9edBee550619E6bC35a9cAdECFd614240ED',
  [SupportedChainId.POLYGON]: '0x6a055C65d46fEe70d0d6cc22dF857cfc22D6cE55',
}
export const KROM_TOKEN_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.POLYGON_MUMBAI]: '0x605Daf536A6BC958fFe259bE53dD6c227cf92B30',
...
export const UNISWAP_UTILS_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.KOVAN]: '0xf3c99b79Af8Cf798B16855C1A2a7387b8E242874',
  [SupportedChainId.POLYGON]: '0xd6C0376a17758251964161210AF7f6d16dB21B67',
}
