...
function colors(darkMode: boolean): Colors {
  return {
    ...
    //primary colors
    primary1: darkMode ? '#945DC8' : '#E8006F',
    primary2: darkMode ? '#9f6dce' : '#FF8CC3',
    primary3: darkMode ? '#a97dd3' : '#FF99C9',
    primary4: darkMode ? '#8554b470' : '#F6DDE8',
    primary5: darkMode ? '#764aa070' : '#FDEAF1',
