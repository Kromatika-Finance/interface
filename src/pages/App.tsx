...
export default function App() {
  ...
  return (
    <ErrorBoundary>
      ...
      <Web3ReactManager>
        <Switch>
          <Route exact strict path="/swapwidget/dark" component={SwapWidget} />
          <Route path="/swapwidget" component={SwapWidget} />
          <Route exact path="/swapwidget/light" component={SwapWidget} />
          <AppWrapper>
            <HeaderWrapper>
              <Header />
            </HeaderWrapper>
