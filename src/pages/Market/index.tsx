...
const MobilePositioning = styled.div`
...
const GasIconWrapper = styled.div`
  @media screen and (max-width: 1000px) {
    display: flex;
    justify-content: end;
    position: relative;
...
`
const TradePriceWrapper = styled.span`
  @media screen and (max-width: 1000px) {
    font-size: 14px;
  }
`
                  ...
                  <AutoColumn gap={'sm'}>
                    ...
                    {!showWrap && trade && (
                      <div>
                          ...
                          <RowFixed>
                            <LoadingOpacityContainer $loading={routeIsSyncing}>
                              <MobilePositioning>
                                <TYPE.subHeader>
                                  <GasIconWrapper>
                                    <TradePriceWrapper>${swapTransaction?.gasUseEstimateUSD}</TradePriceWrapper>
                                    <svg
                        ...
                        <Row justify={!trade ? 'center' : 'space-between'} style={{ marginTop: '5px' }}>
                          <RowFixed>
                            <MouseoverTooltipContent
                              wrap={false}
                              content={
                          ...
                          {uniSavings && fiatValueOutput && uniSavings.lessThan(fiatValueOutput) ? (
                            <Row justify={'end'} style={{ height: '24px', marginTop: '5px' }}>
